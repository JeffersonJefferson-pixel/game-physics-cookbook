...
enum ImGuiTreeNodeFlags_
{
    ...
    //ImGuITreeNodeFlags_SpanAllAvailWidth  = 1 << 10,  // FIXME:Extend hit box horizontally even if not framed
    //ImGuiTreeNodeFlags_NoScrollOnOpen     = 1 << 11,  // FIXME:  Disable automatic scroll on TreePop() if node got just open and contents is not visible
